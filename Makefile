...
tsp.o: tsp.c
	mpicc -c -g -Wall -std=c99 tsp.c

tsp_static.o: tsp_static.c
	mpicc -c -g -Wall -std=c99 tsp_static.c

main.o: main.c
	mpicc -c -g -Wall -std=c99 main.c

# make the executables: course example, dynamic and static.
tsp_236370: main.o tsp_236370.o
	mpicc -g -o tsp_236370 main.o tsp_236370.o

tsp: main.o tsp.o
	mpicc -g -o tsp main.o tsp.o

tsp_static: main.o tsp_static.o
	mpicc -g -o tsp_static main.o tsp_static.o
